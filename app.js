...
app.get('/search', (req, res) => {
  const restaurantFilter = restaurantList.results.filter( x => 
    {
      if(x.name.toLowerCase().includes(req.query.keyword.toLowerCase()) || x.category.toLowerCase().includes(req.query.keyword.toLowerCase()))
      return x
    })
